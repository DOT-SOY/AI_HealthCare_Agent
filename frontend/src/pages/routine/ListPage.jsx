      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg font-medium transition-colors border-2 border-[#88ce02] text-[#88ce02] hover:bg-[#88ce02] hover:text-neutral-900"
          >
            루틴 생성
          </button>
        </div>
        ...
        <>
          ...
          <div className="flex flex-col items-center justify-center py-6 mb-6">
            ...
            <p className="text-neutral-500 text-sm mb-6">
              아래 프로그램을 선택하면 오늘부터 연속된 날짜에 루틴이 생성됩니다.
            </p>
          </div>
