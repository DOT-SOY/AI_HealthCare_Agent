...
public interface MemberBodyInfoService {
     ...
     * 신체 정보 생성
     */
    MemberBodyInfo create(MemberBodyInfoRequestDto requestDto);
     ...
     * 회원별 신체 정보 전체 조회
     */
    List<MemberBodyInfo> findByMemberId(String memberId);
     ...
     * 신체 정보 수정
     */
    MemberBodyInfo update(Long id, MemberBodyInfoRequestDto requestDto);
