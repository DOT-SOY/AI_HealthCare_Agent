       ...
       public void resetMemberInfoBodyTableAndInsertSample() {
        ...
        jdbcTemplate.execute("""
                CREATE TABLE IF NOT EXISTS member_info_body (
                    ...
                    data_source VARCHAR(20) NULL, -- OCR, MANUAL
        ...
        String insertSql = """
                ...
                (
                  ...
                  goal_type, data_source
                )
                VALUES
                (%d, '2025-12-03 09:00:00', 175.0, 72.4, 31.8, 23.5, 40.2, 11.8, 3.9, 17.0, 68.0, -4.4, -3.2, 1.0, 'DIET', 'OCR'),
                (%d, '2025-12-10 09:00:00', 175.0, 72.0, 31.9, 23.1, 40.3, 11.9, 3.9, 16.6, 68.0, -4.0, -3.0, 1.0, 'DIET', 'OCR'),
                (%d, '2025-12-17 09:00:00', 175.0, 71.6, 32.0, 22.8, 40.4, 11.9, 3.9, 16.3, 68.0, -3.6, -2.8, 1.0, 'DIET', 'OCR'),
                (%d, '2025-12-24 09:00:00', 175.0, 71.2, 32.1, 22.5, 40.5, 12.0, 3.9, 16.0, 68.0, -3.2, -2.6, 1.0, 'DIET', 'OCR'),
                (%d, '2025-12-31 09:00:00', 175.0, 70.8, 32.2, 22.1, 40.6, 12.0, 3.9, 15.7, 68.0, -2.8, -2.4, 1.0, 'DIET', 'OCR'),
                (%d, '2026-01-07 09:00:00', 175.0, 70.5, 32.3, 21.8, 40.7, 12.1, 4.0, 15.4, 68.0, -2.5, -2.2, 1.0, 'DIET', 'OCR'),
                (%d, '2026-01-14 09:00:00', 175.0, 70.2, 32.4, 21.5, 40.8, 12.1, 4.0, 15.1, 68.0, -2.2, -2.0, 1.0, 'DIET', 'OCR'),
                (%d, '2026-01-21 09:00:00', 175.0, 69.9, 32.5, 21.2, 40.9, 12.2, 4.0, 14.8, 68.0, -1.9, -1.8, 1.0, 'DIET', 'OCR');
